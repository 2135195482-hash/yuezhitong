...
const PUBLIC_DISCLAIMER =
  '本工具仅对用户自行录入的志愿候选方案进行整理和辅助分析，不提供官方招生数据，不构成录取预测或志愿填报承诺。院校代码、院校专业组代码、专业代码、招生计划、选科要求、收费标准和录取规则，必须以《广东省2026年普通高等学校招生专业目录》、广东省教育考试院志愿填报系统及高校2026年招生章程为准。本工具不代替广东省官方辅助系统，不保证录取，不自动提交志愿，不保存志愿系统密码，用户必须自行完成官方系统中的最终确认。'
