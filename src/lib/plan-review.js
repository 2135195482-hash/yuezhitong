...
const PUBLIC_DISCLAIMER =
  '本系统内置的是广东省教育考试院公开发布的历史院校专业组投档数据，不是具体专业录取数据，也不是2026年招生计划。历史投档结果仅供研究参考。2026年院校代码、院校专业组代码、招生专业、选科要求、招生计划、收费标准和录取规则，必须以广东省教育考试院官方志愿系统、《广东省2026年普通高等学校招生专业目录》及高校2026年招生章程为准。本工具不保证录取，不自动提交志愿，不收集志愿系统密码；用户输入默认保存在本机浏览器，清除浏览器数据可能导致方案丢失，建议导出备份。'
