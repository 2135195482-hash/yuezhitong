  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      <section className="py-6">
        <p className="text-sm font-medium text-[var(--color-primary)]">粤志通 2026 官方历史数据静态测试版</p>
        <h1 className="mt-2 text-3xl font-bold text-[var(--color-text)]">广东高考志愿辅助与复核助手</h1>
        <p className="mt-4 max-w-3xl text-lg leading-relaxed text-[var(--color-text)]">
          查询广东省教育考试院公开历史投档数据，再把你初步选好的院校专业组放进来，帮你检查梯度、专业方向、费用与退档风险。
        </p>
        <p className="mt-3 max-w-3xl text-sm leading-relaxed text-[var(--color-text-muted)]">
          内置数据只覆盖2023-2025年普通类本科批院校专业组投档情况，不是具体专业录取数据，也不是2026招生计划。2026代码、专业组、招生专业和计划必须回到官方目录与志愿系统核验。
        </p>
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/official" className="rounded bg-[var(--color-primary)] px-6 py-3 text-sm font-semibold text-white no-underline">
            查询官方历史数据
          </Link>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <InfoCard title="1. 查历史投档" text="按年份、科类、院校名称或代码查询广东省教育考试院公开的历史院校专业组投档数据。" />
        <InfoCard title="2. 建研究方案" text="可把历史记录加入研究方案，再手动补充2026院校代码、专业组代码、招生专业和计划。" />
      ...
      <section className="mt-6 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
        ...
        <ul className="mt-3 space-y-2 text-sm text-[var(--color-text-muted)]">
          <li>内置数据是历史院校专业组投档数据，不是具体专业录取数据，也不是2026招生计划。</li>
