"""
Guangdong 2023 Gaokao Admission Data Parser
SOURCE: 广东省教育考试院
PAGE: "我省2023年普通高考本科批次正式投档"
PAGE URL: https://eea.gd.gov.cn/ptgk/content/post_4221648.html

Parses official ZIP attachments into structured records.
Input: data/official/raw/2023/archive/4221648.zip
...
SOURCE_PAGE_TITLE = "我省2023年普通高考本科批次正式投档"
SOURCE_PAGE_URL = "https://eea.gd.gov.cn/ptgk/content/post_4221648.html"
OFFICIAL_PUBLISHED_AT = "2023-07-19"
SOURCE_ATTACHMENT_URL = "https://eea.gd.gov.cn/attachment/0/526/526559/4221648.zip"

BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
RAW_DIR = os.path.join(BASE_DIR, "data", "official", "raw", "2023")
